...
void mainRoutine() {
 ...
 //tempSen02_read()<70 && tempSen03_read()<70 && (tempSen02_read() + 5) < tempSen01_read() && (tempSen03_read()+5) < tempSen01_read() && tempSen01_read()>=50
       
    if (tempSen02_read()<70 && tempSen03_read()<70 && (tempSen02_read() + 5) < tempSen01_read() && (tempSen03_read()+5) < tempSen01_read() && tempSen01_read()>=50)
    { //Serial.println(millis()); //prints time since program started
      //Serial.println(lastMillis); //prints time since program started 
      if (tempSen02_read() >= tempSen04_read())
      { //after 5secs
