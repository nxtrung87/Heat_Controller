 ...
 //################################# STATE CHECKING ##################################
  ...
  // ================================== STATE A1 ============================
    ...
    if (tempSen01_read()<60)
    {
      ...
      if (tempSen02_read() >= (tempSen04_read() + 5))
      {
        if ((millis()-lastMillis)>10000)
        {
          lastMillis = millis();
...
//      }
   ...
   // ================================== STATE D ============================
    ...
    //---------------------//----------------------
    if(tempSen01_read()>50 && tempSen02_read()<=85  && tempSen03_read()<=85 && (tempSen02_read()+5) <= tempSen01_read() && (tempSen03_read()+5) <= tempSen01_read() && tempSen02_read() >= tempSen04_read())
    {
      lastMillis = millis();
    }
   
    else if(tempSen01_read()>50 && tempSen02_read()<=85  && tempSen03_read()<=85 && (tempSen02_read()+5) <= tempSen01_read() && (tempSen03_read()+5) <= tempSen01_read() &&  tempSen02_read() < tempSen04_read())
    {
        if ((millis()-lastMillis)>10000)
        { //after 10 secs
          lastMillis = millis();
      ...
      //else {lastMillis = millis();}
       ...
       //(tempSen02_read() + 5)
    else if ((tempSen02_read()>85 || (tempSen02_read() + 5) > tempSen01_read() || tempSen01_read()<=50 || (tempSen03_read() +5) > tempSen01_read() || tempSen03_read()>85) && tempSen02_read() >= tempSen04_read())
    { 
      if ((millis()-lastMillis)>10000)
      { //after 5secs
        lastMillis = millis();
  ...
  // ================================== STATE D1 ============================
    ...
    else if(tempSen01_read()>50 && tempSen02_read()<=85  && tempSen03_read()<=85 && (tempSen02_read()+5) <= tempSen01_read() && (tempSen03_read()+5) <= tempSen01_read() && tempSen02_read() >= (tempSen04_read()+5))
    {
        if ((millis()-lastMillis)>10000)
        { //after 10 secs
          lastMillis = millis();
